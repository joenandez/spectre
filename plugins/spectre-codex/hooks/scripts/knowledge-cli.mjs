...
function usage() {
  return [
    ...
    '  knowledge-cli.mjs capture --kind knowledge|work --input <json|-> [--record-id <id>] [--work-id <id>] [--source-run-id <id>|--run-id <id>] [--pull-request-id <id>] [--candidate <json>] [--branch <exact-branch>] [--branch-pr-state open|merged|closed] [--expected-revision <token>] --project-dir <path> [--json]',
