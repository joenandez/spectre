...
- **Primary-owned dispatch:** directly dispatch leaf `@spectre_tester` agents in parallel—one message/multiple tasks; P0 = one agent/file, P1 = 2–3 files/agent, P2 = 3–5, up to 8. Give batch paths/tier and require behavioral, outcome-not-call, mutation-resistant tests; wait before verifying.
