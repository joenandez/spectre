...
1. **Evidence.** Find unsupported claims; if needed, at most one each `@spectre:finder`, `@spectre:analyst`, `@spectre:patterns` in parallel for cited evidence/unknowns (≤1,000 tokens).
