...
1. **Evidence.** Find unsupported claims; at most one each `@spectre:finder`, `@spectre:analyst`, `@spectre:patterns` for cited evidence/unknowns (≤1,000 tokens).
