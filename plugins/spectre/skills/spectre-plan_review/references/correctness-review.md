...
Write report first; then only authorized selected-plan edits. Include metadata/hashes, evidence, constraints/tests, findings/dispositions/edits. Emit only the injected direct-write receipt with post-write `REPORT_SHA256`/`PLAN_SHA256`.
